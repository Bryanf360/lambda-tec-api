...
export class PartNumberController {
    ...
    public createPartNumber = async (req: Request, res: Response): Promise<any> => {
        ...
        this.partNumberService
            .createPartNumber(createPartNumberDto!)
            .then((partNumber) =>
                res.status(200).json({
                    success: true,
    ...
    public getPartNumbersByModel = async (req: Request, res: Response): Promise<any> => {
        ...
        this.partNumberService
            .getPartNumbersByModelId(+modelId, paginationDto!)
            .then((result) =>
                res.status(200).json({
                    success: true,
                    ...result,
    ...
    public updatePartNumber = async (req: Request, res: Response): Promise<any> => {
        ...
        this.partNumberService
            .updatePartNumberById(+id, updatePartNumberDto!)
            .then((partNumber) =>
                res.status(200).json({
                    success: true,
